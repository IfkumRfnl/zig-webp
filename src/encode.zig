...
test "bounded mutation exploration of lossless encode" {
    const testing_fuzz = @import("testing/fuzz.zig");
    ...
    try testing_fuzz.runMutations(fuzzEncodeLosslessOne, &seed_payload, .{ .prng_seed = 0x11d_0005 });
}
...
test "bounded mutation exploration of lossy encode" {
    const testing_fuzz = @import("testing/fuzz.zig");
    ...
    try testing_fuzz.runMutations(fuzzEncodeLossyOne, &seed_payload, .{ .prng_seed = 0x11d_0006 });
}
