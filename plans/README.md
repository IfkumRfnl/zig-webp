...
| 015 | C-ABI export layer — design document (PLAN.MD section, no code) | P2 | M | 012, 013 | DONE — branch `c-abi-design` (design commit `43f947f`; review follow-ups on tip); `PLAN.MD` step-13 section only; follow-up implementation post-1.0; not merged |
