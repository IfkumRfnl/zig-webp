...
| 015 | C-ABI export layer — design document (PLAN.MD section, no code) | P2 | M | 012, 013 | DONE — PR #102 (branch `c-abi-design`); `PLAN.MD` step-13 section only; follow-up implementation post-1.0; not merged |
