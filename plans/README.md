...
| 026 | Luma SSIM column in the lossy encode report | P3 | S | — | DONE — local on `metrics-luma-ssim`; textbook `ssimLuma` + report column; first corpus mean SSIM 0.989985; finite-row PSNR mean fixed to 42.08 dB / 30 |
